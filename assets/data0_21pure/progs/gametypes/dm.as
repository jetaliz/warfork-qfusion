...
void GT_InitGametype()
{
    ...
    if ( !G_FileExists( "configs/server/gametypes/" + gametype.name + ".cfg" ) )
    {
        ...
        config = "// '" + gametype.title + "' gametype configuration file\n"
                 ...
                 + "\n\n// map rotation\n"
                 + "set g_maplist \"wfdm1 wfdm2 wfdm4 wfdm5 wfdm6 wfdm7 wfdm9 wfdm10 wfdm11 wfdm12 wfdm13 wfdm14 wfdm15 wfdm18 wfdm19 wfdm20\" // list of maps in automatic rotation\n"
