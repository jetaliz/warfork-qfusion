...
String @GT_ScoreboardMessage( uint maxlen )
{
    ...
    for ( i = 0; @team.ent( i ) != null; i++ )
    {
        ...
        // "AVATAR Name Clan Score Tagtime Ping R"
...
void GT_InitGametype()
{
    ...
    G_ConfigString( CS_SCB_PLAYERTAB_LAYOUT, "%a l1 %n 112 %s 52 %i 52 %s 52 %l 48 %r l1" );
    G_ConfigString( CS_SCB_PLAYERTAB_TITLES, "AVATAR Name Clan Score Tagtime Ping R" );
